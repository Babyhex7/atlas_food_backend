...
- **Sehingga** saya bisa langsung isi survey tanpa registrasi

**Acceptance Criteria:**
- Responden bisa klik link dan langsung masuk survey
- System generate anonymous participant ID
- Responden bisa isi nama (opsional)
- Data tersimpan dengan participant alias
